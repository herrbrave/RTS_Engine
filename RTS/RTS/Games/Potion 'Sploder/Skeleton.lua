...
function setup()
	...
	loadSound("Assets/Potion 'Sploder/Sounds/skeleton_moan_1.wav", "skeleton_moan_1")
	loadSound("Assets/Potion 'Sploder/Sounds/skeleton_moan_2.wav", "skeleton_moan_2")
	loadSound("Assets/Potion 'Sploder/Sounds/skeleton_moan_3.wav", "skeleton_moan_3")
	loadSound("Assets/Potion 'Sploder/Sounds/skeleton_attack_1.wav", "skeleton_attack_1")
	loadSound("Assets/Potion 'Sploder/Sounds/skeleton_attack_2.wav", "skeleton_attack_2")
...
function update(delta)
	...
	elseif state == IDLE then
		if moan_timer > next_moan then
			local moan = random(2)
			playSound("skeleton_moan_" .. tostring(moan + 1), -1, 0)
			moan_timer = 0
			next_moan = 2000 + random(1000)
		end
		moan_timer = moan_timer + delta
	...
	elseif state == ATTACK then
		...
		if move_dir:magnitude() <= 45 then
			...
			local moan = random(1)
			playSound("skeleton_attack_" .. tostring(moan + 1), -1, 0)
		end
