...
function setup()
	...
	include("Games/Potion 'Sploder/AssistantMoveState.lua")
	...
	while _i <= context.inventorySizeMax do
		...
		context.inventory[_i].id = createTextured("Assets/Potion 'Sploder/Sprites/Dungeon_Tileset.png", 185 + (_i * 80), 700, 80, 80, 0, 128, 16, 16)
	...
	loadSound("Assets/Potion 'Sploder/Sounds/throw_bones.wav", "throw_bones")
	loadSound("Assets/Potion 'Sploder/Sounds/throw_bones.wav", "throw_bones")
	loadMusic("Assets/Potion 'Sploder/Sounds/theme_dark_side.wav", "theme_dark_side")
	playMusic("theme_dark_side")
end
...
function updateInventoryImages()
	...
	for i=0,context.inventorySizeMax do
		...
		if context.inventory[i].type == context.INVENTORY_EMPTY then
			setTexture("Assets/Potion 'Sploder/Sprites/Dungeon_Tileset.png", context.inventory[i].id, 64, 64, 0, 128, 16, 16)
		elseif context.inventory[i].type == context.INVENTORY_BONES then
			setTexture("Assets/Potion 'Sploder/Sprites/Dungeon_Tileset.png", context.inventory[i].id, 64, 64, 112, 112, 16, 16)
		elseif context.inventory[i].type == context.INVENTORY_GOLD then
			setTexture("Assets/Potion 'Sploder/Sprites/Dungeon_Tileset.png", context.inventory[i].id, 64, 64, 96, 128, 16, 16)
		end
	end
end