...
function setup()
	...
	attachAsepriteAnimationSet(entityId, "Assets/HackNSlasher/Visual FX/Looping Fire/Fireball 16x16.json")
	setSpeed(entityId, 200);
	setZOrder(entityId, 3)

	setAnimation(entityId, "fire")
...
function onCollision(id)
	print("fireball collided", id)
	if not isExploding then
		isExploding = true
		setSize(entityId, 64, 64)
		setVelocity(entityId, 0, 0)
		attachAsepriteAnimationSet(entityId, "Assets/HackNSlasher/Visual FX/Explosions/Explosion 32x32.json")
